...
const AlumniProfile = ({ user, registration, onStartRegistration }: AlumniProfileProps) => {
  // The alumni record is only available once the registration form has been
  // completed and submitted.
  if (!registration) {
    return (
      <div className="alumni-desktop-page">
        <div className="alumni-page-heading">
          <h1>My Profile</h1>
        ...
        <div className="alumni-gate">
          ...
          <button className="btn btn-primary alumni-submit" onClick={onStartRegistration}>
            <UserPlus size={16} />
