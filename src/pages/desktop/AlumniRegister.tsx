...
const AlumniRegister = ({ isOpen, onClose, onRegistered }: AlumniRegisterProps) => {
  ...
  if (pendingData) {
    return (
      <div className="alumni-modal-overlay" role="dialog" aria-modal="true" aria-label="Review your registration">
        <div className="alumni-modal">
          ...
          <div className="alumni-modal-body">
            ...
            <div className="alumni-actions-row">
              ...
              <button type="button" className="btn btn-primary alumni-submit" onClick={handleConfirm} disabled={loading}>
                {loading ? (
